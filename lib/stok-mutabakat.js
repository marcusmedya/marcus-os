 ...
 */
import { paylasimTuru, PAYLASIM_TURLERI, stokAnahtari, stoklariBirlestir } from "./stok.js";
...
export function stokMutabakati(veri) {
  const d = veri && typeof veri === "object" ? veri : {};
  /* KAYITLI STOK TOPLANMIŞ HÂLİYLE KARŞILAŞTIRILIYOR.
   *
   * Belgede eski tür anahtarları duruyor (`1_Görsel`, `1_Story`, `1_Video`…). Ham hâliyle
   * karşılaştırılınca `gereken` yeni türlerde, `kayitli` eski türlerde oluyor ve BÜTÜN
   * markalar "uyuşmuyor" görünüyordu — ekranda 22 satır sahte sapma çıktı, üstelik
   * kartta "Post 5" yazarken rapor "0 kayıtlı" diyordu. Ölçüldü. */
  const kayitli = stoklariBirlestir(d.stoklar && typeof d.stoklar === "object" ? d.stoklar : {});
