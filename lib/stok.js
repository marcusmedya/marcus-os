...
export function paylasimTuru(is) {
  ...
  /* "fotoğraf" da aranıyor: adı yalnızca "FOTOĞRAF" olan kategorisiz kartlar vardı ve
   * hiçbir kelimeye takılmadıkları için Reels'e düşüyorlardı. Ölçüldü. */
  if (/görsel|gorsel|post|fotoğraf|fotograf/.test(ad)) return "Post";
