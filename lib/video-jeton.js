 ...
 *
 * PARÇA BOYU ölçülü seçildi: büyük olursa süre/boyut sınırlarına yaklaşıyor, küçük
 * olursa istek sayısı artıyor. 3 MB, 1080p dikey bir videoda birkaç saniyelik görüntü.
 *
 ...
 * ================================================================ */
export const VIDEO_PARCA_BAYT = 3 * 1024 * 1024;
