export const DEFAULT_DATA = {
  ...
  clients: [
    ...
    { id: 2, ad: "Lezzet Sofrası", kategori: "Restoran Zinciri", durum: "aktif", aylikUcret: 45000, karMarji: 62, baslangic: "2024-06", not: "" },
    { id: 3, ad: "UrbanFit Spor Kulübü", kategori: "Spor & Wellness", durum: "aktif", aylikUcret: 32000, karMarji: 55, baslangic: "2025-01", not: "" },
    { id: 4, ad: "Mavi Deniz Otelcilik", kategori: "Turizm", durum: "yeni", aylikUcret: 40000, karMarji: 48, baslangic: "2026-06", not: "" },
    ...
    { id: 6, ad: "Altın Kuyumcu", kategori: "Perakende", durum: "ayrildi", aylikUcret: 0, karMarji: 0, baslangic: "2024-02", not: "" },
  ],
  operasyonlar: [
  ...
  gelirKalemleri: [
    { id: 1, kalem: "Aylık Yönetim Bedelleri", tutar: 193000 },
    { id: 2, kalem: "Proje Bazlı Çekimler", tutar: 28000 },
    { id: 3, kalem: "Reklam Yönetim Komisyonu", tutar: 10000 },
  ],
  giderKalemleri: [
    { id: 1, kalem: "Personel Maaşları", tutar: 68000 },
    { id: 2, kalem: "Ekipman & Kiralama", tutar: 14000 },
    { id: 3, kalem: "Reklam Harcaması (Müşteri Adına)", tutar: 22000 },
    { id: 4, kalem: "Ofis & Sabit Giderler", tutar: 9000 },
    { id: 5, kalem: "Yazılım & Araçlar", tutar: 6000 },
  ],
  bekleyenTahsilatlar: [
