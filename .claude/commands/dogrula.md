...
```
Beklenen: `SONUÇ: 196 kontrol geçti, uygulama açılıyor.` ve `ÇIKIŞ: 0`.
...
On üç senaryo var: ilk kurulum · dashboard · müşteri detay paneli (üç sekme geçişiyle) ·
sağlıklı marka · dar ekranda panel · Finans → Doğrulama · personel Finans sekmeleri ·
yalnızca ödeme takvimi izni · dar ekranda Finans sekmeleri · Finans → Önümüzdeki Aylar ·
dar ekranda Önümüzdeki Aylar · müşteri formu ızgarası (yeni müşteri formu AÇILIYOR ama
DOLDURULMUYOR) · yazma hatası uyarıları (Üyelikler ekranında 403 sonra 401: uyarı yığını,
`alert` açılmaması, 401'de giriş ekranına alınma). Bunların DIŞINDAKİ hiçbir ekrana
tıklanmıyor, kart açılmıyor, dosya yüklenmiyor. "Uygulama
