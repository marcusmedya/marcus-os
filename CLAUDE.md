...
testler/     114 test dosyası (t1…t114) + 27 statik denetim betiği
...
okundu ve uygulama SİYAH EKRANLA açılmadı; üretime böyle çıktı. Derleme ve 2693 kontrolün
...
./testler/sunucutestleri.sh        # t1…t114, 2693 kontrol — SAHTE veritabanı kullanır
...
ve açılışta yakalanmamış JS hatası olmadığını doğrular. **Altı senaryo, 84 kontrol**:
boş veritabanı · dolu veritabanı · **müşteri detay paneli** · **sağlıklı marka paneli** ·
**dar ekranda müşteri paneli** · **Finans → Doğrulama sekmesi**. **Ölçüldü**: hata bileşen gövdesine geri konulduğunda
derleme 0, denetimler 0, 2693 kontrol geçiyor — yalnızca bu test düşüyor.
