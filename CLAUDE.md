...
okundu ve uygulama SİYAH EKRANLA açılmadı; üretime böyle çıktı. Derleme ve 2765 kontrolün
...
./testler/sunucutestleri.sh        # t1…t116, 2765 kontrol — SAHTE veritabanı kullanır
...
ve açılışta yakalanmamış JS hatası olmadığını doğrular. **On iki senaryo, 175 kontrol**:
...
**dar ekranda Önümüzdeki Aylar** · **müşteri formu ızgarası**. **Ölçüldü**: hata bileşen gövdesine geri konulduğunda
derleme 0, denetimler 0, 2765 kontrol geçiyor — yalnızca bu test düşüyor.
