...
okundu ve uygulama SİYAH EKRANLA açılmadı; üretime böyle çıktı. Derleme ve 2808 kontrolün
...
./testler/sunucutestleri.sh        # t1…t117, 2808 kontrol — SAHTE veritabanı kullanır
...
ve açılışta yakalanmamış JS hatası olmadığını doğrular. **On üç senaryo, 196 kontrol**:
...
**dar ekranda Önümüzdeki Aylar** · **müşteri formu ızgarası** · **yazma hatası uyarıları**.
**Ölçüldü**: hata bileşen gövdesine geri konulduğunda derleme 0, denetimler 0, 2808 kontrol
geçiyor — yalnızca bu test düşüyor.
